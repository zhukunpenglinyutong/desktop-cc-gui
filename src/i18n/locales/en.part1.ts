const enPart1 = {
  ...
  settings: {
    ...
    sessionOrganizationTreeLabel: "Session organization tree",
    sessionOrganizationUnfiledNodeLabel: "📥 Unfiled",
    sessionOrganizationUnfiledCount: "{{count}} unfiled sessions",
    sessionOrganizationFolderCount: "{{count}} direct sessions",
    sessionOrganizationExpandFolder: "Expand folder {{name}}",
    sessionOrganizationCollapseFolder: "Collapse folder {{name}}",
    sessionOrganizationDirectCount: "{{count}} direct sessions",
    sessionOrganizationRightPanePlaceholder:
      "Select a node on the left to inspect its direct sessions. Subfolder cards and the detail modal arrive in the next steps.",
    sessionOrganizationUnfiledEmpty: "No unfiled sessions visible yet.",
    sessionOrganizationFolderEmpty: "This folder has no direct sessions yet.",
    sessionOrganizationToggleSelectionAria: "Select session {{title}}",
    sessionOrganizationOpenSessionAria: "Open session {{title}}",
    sessionOrganizationLastUpdatedAria: "Last updated {{value}}",
    sessionOrganizationSubfolderGridLabel: "Subfolder list",
    sessionOrganizationSubfolderGridTitle: "Subfolders",
    sessionOrganizationSubfolderGridCount: "{{count}} total",
    sessionOrganizationSubfolderCardCount: "{{count}} direct sessions",
    sessionOrganizationSubfolderCardAria:
      "Open subfolder {{name}} with {{count}} direct sessions",
    sessionOrganizationTimelineToolBadge: "Tool call ({{type}})",
    sessionOrganizationModalEngine: "Engine {{engine}}",
    sessionOrganizationModalUpdated: "Last updated {{value}}",
    sessionOrganizationModalFolderPath: "Folder {{path}}",
    sessionOrganizationModalParentSession: "Parent session {{id}}",
    sessionOrganizationModalCloseAria: "Close session detail",
    sessionOrganizationModalOpenInMain: "Open in main window",
    sessionOrganizationModalOpenInMainNotWired:
      "Main-window switching is not wired yet; it will arrive in a follow-up release.",
    sessionOrganizationModalLoadError: "Failed to load: {{error}}",
    sessionOrganizationModalLoading: "Loading session history...",
    sessionOrganizationModalEmpty: "Nothing to display for this session.",
    sessionOrganizationModalWorkspacePathMissing:
      "Cannot resolve the local path for this workspace; session history is unavailable.",
    sessionOrganizationModalEngineUnsupported:
      "Reading {{engine}} session history is not supported yet.",
    sessionOrganizationMoveToFolderButton: "Move to folder…",
    sessionOrganizationMoveToFolderTitle: "Move {{count}} sessions to folder",
    sessionOrganizationMoveToFolderUnfileLabel: "📥 Unfile",
    sessionOrganizationMoveToFolderApply: "Move",
    sessionOrganizationMoveToFolderApplying: "Moving…",
    sessionOrganizationMoveToFolderCancel: "Cancel",
    sessionOrganizationMoveToFolderCloseAria: "Close move-to-folder dialog",
    sessionOrganizationMoveToFolderListAria: "Target folders list",
    sessionOrganizationMoveToFolderLoading: "Loading folder list…",
    sessionOrganizationMoveToFolderEmpty:
      "This workspace has no folders yet. Create one in the organize view first.",
    sessionOrganizationMoveSuccess: "Moved {{count}} sessions.",
    sessionOrganizationMovePartial:
      "{{succeeded}} succeeded, {{failed}} failed: {{reason}}",
    sessionOrganizationCreateRootFolderButton: "New folder",
    sessionOrganizerCreateSubfolderButton: "New subfolder",
    sessionOrganizationRenameSelectedButton: "Rename",
    sessionOrganizationDeleteSelectedButton: "Delete",
    ...
    sessionOrganizationCreateSubfolderButtonAria:
      "Create subfolder under {{name}}",
    sessionOrganizationRenameFolderButtonAria: "Rename {{name}}",
    sessionOrganizationDeleteFolderButtonAria: "Delete {{name}}",
    sessionOrganizationDeleteFolderArmedAria:
      "Click again to confirm delete of {{name}}",
    sessionOrganizationFolderNameInputAria: "Folder name",
    sessionOrganizationFolderNamePlaceholder: "Enter folder name",
    sessionOrganizationFolderNameSave: "Save",
    sessionOrganizationFolderNameCancel: "Cancel",
    sessionOrganizationFolderNameRequired: "Folder name cannot be empty.",
    sessionOrganizationDeleteBlockedNonEmpty:
      "This folder still contains sessions or subfolders. Empty or unfile its contents first.",
    sessionOrganizationDeleteFolderDialogTitle: "Delete \"{{name}}\"",
    sessionOrganizationDeleteFolderDialogEmptyBody:
      "Are you sure you want to delete this empty folder?",
    sessionOrganizationDeleteFolderDialogNonEmptyBody:
      "This folder and its subfolders contain {{sessionCount}} sessions and {{subfolderCount}} subfolders.",
    sessionOrganizationDeleteFolderCascadeOption:
      "Also delete all inner sessions (local files will be permanently removed)",
    sessionOrganizationDeleteFolderUnfileHint:
      "If unchecked, all related sessions move back to \"Unfiled\"; subfolders are still removed.",
    sessionOrganizationDeleteFolderConfirm: "Delete",
    sessionOrganizationDeleteFolderCancel: "Cancel",
    sessionOrganizationDeleteFolderInProgress: "Deleting…",
    sessionOrganizerOpenButton: "Organize sessions",
    sessionOrganizerOpenButtonAria: "Open sessions organizer",
    sessionOrganizerModalTitle: "Organize — {{workspace}}",
    sessionOrganizerModalSubtitle:
      "View, move and re-shape sessions by folder. Batch actions live in the footer toolbar.",
    sessionOrganizerCloseAria: "Close sessions organizer",
