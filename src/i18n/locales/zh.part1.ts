const zhPart1 = {
  ...
  settings: {
    ...
    sessionOrganizationTreeLabel: "会话整理 - 专题树",
    sessionOrganizationUnfiledNodeLabel: "📥 未分类",
    sessionOrganizationUnfiledCount: "未分类共 {{count}} 个会话",
    sessionOrganizationFolderCount: "{{count}} 个直属会话",
    sessionOrganizationExpandFolder: "展开专题 {{name}}",
    sessionOrganizationCollapseFolder: "折叠专题 {{name}}",
    sessionOrganizationDirectCount: "直属会话 {{count}} 个",
    sessionOrganizationRightPanePlaceholder:
      "选中左侧节点查看直属会话列表；后续步骤会接通完整会话列表、子专题卡片与详情 modal。",
    sessionOrganizationUnfiledEmpty: "未分类暂无可见会话。",
    sessionOrganizationFolderEmpty: "该专题暂无直属会话。",
    sessionOrganizationToggleSelectionAria: "选择会话 {{title}}",
    sessionOrganizationOpenSessionAria: "打开会话 {{title}}",
    sessionOrganizationLastUpdatedAria: "最近更新 {{value}}",
    sessionOrganizationSubfolderGridLabel: "子专题列表",
    sessionOrganizationSubfolderGridTitle: "子专题",
    sessionOrganizationSubfolderGridCount: "共 {{count}} 个",
    sessionOrganizationSubfolderCardCount: "直属 {{count}} 个会话",
    sessionOrganizationSubfolderCardAria: "进入子专题 {{name}}，直属 {{count}} 个会话",
    sessionOrganizationTimelineToolBadge: "工具调用 ({{type}})",
    sessionOrganizationModalEngine: "引擎 {{engine}}",
    sessionOrganizationModalUpdated: "最近更新 {{value}}",
    sessionOrganizationModalFolderPath: "所属 {{path}}",
    sessionOrganizationModalParentSession: "父会话 {{id}}",
    sessionOrganizationModalCloseAria: "关闭会话详情",
    sessionOrganizationModalOpenInMain: "在主窗口打开此会话",
    sessionOrganizationModalOpenInMainNotWired:
      "主窗口跳转能力尚未接通，将在后续版本可用。",
    sessionOrganizationModalLoadError: "加载失败：{{error}}",
    sessionOrganizationModalLoading: "正在加载会话历史...",
    sessionOrganizationModalEmpty: "没有可显示的会话内容。",
    sessionOrganizationModalWorkspacePathMissing: "无法定位该工作区的本地路径，无法读取会话历史。",
    sessionOrganizationModalEngineUnsupported: "暂不支持读取 {{engine}} 引擎的会话历史。",
    sessionOrganizationMoveToFolderButton: "移动到专题…",
    sessionOrganizationMoveToFolderTitle: "移动 {{count}} 个会话到专题",
    sessionOrganizationMoveToFolderUnfileLabel: "📥 取消归类",
    sessionOrganizationMoveToFolderApply: "移动",
    sessionOrganizationMoveToFolderApplying: "移动中…",
    sessionOrganizationMoveToFolderCancel: "取消",
    sessionOrganizationMoveToFolderCloseAria: "关闭移动到专题对话框",
    sessionOrganizationMoveToFolderListAria: "目标专题列表",
    sessionOrganizationMoveToFolderLoading: "加载专题列表…",
    sessionOrganizationMoveToFolderEmpty: "这个工作区还没有专题。请先在整理视图新建一个。",
    sessionOrganizationMoveSuccess: "已移动 {{count}} 个会话。",
    sessionOrganizationMovePartial:
      "成功 {{succeeded}} 失败 {{failed}}：{{reason}}",
    sessionOrganizationCreateRootFolderButton: "新建专题",
    sessionOrganizerCreateSubfolderButton: "新建子专题",
    sessionOrganizationRenameSelectedButton: "重命名",
    sessionOrganizationDeleteSelectedButton: "删除",
    ...
    sessionOrganizationCreateSubfolderButtonAria: "在 {{name}} 下新建子专题",
    sessionOrganizationRenameFolderButtonAria: "重命名 {{name}}",
    sessionOrganizationDeleteFolderButtonAria: "删除 {{name}}",
    sessionOrganizationDeleteFolderArmedAria: "再次点击以确认删除 {{name}}",
    sessionOrganizationFolderNameInputAria: "专题名称",
    sessionOrganizationFolderNamePlaceholder: "输入专题名称",
    sessionOrganizationFolderNameSave: "保存",
    sessionOrganizationFolderNameCancel: "取消",
    sessionOrganizationFolderNameRequired: "专题名称不能为空。",
    sessionOrganizationDeleteBlockedNonEmpty:
      "该专题仍包含会话或子专题。请先清空或解除归类后再删除。",
    sessionOrganizationDeleteFolderDialogTitle: "删除「{{name}}」",
    sessionOrganizationDeleteFolderDialogEmptyBody:
      "确认删除这个空专题吗？",
    sessionOrganizationDeleteFolderDialogNonEmptyBody:
      "该专题及其子专题里有 {{sessionCount}} 个会话和 {{subfolderCount}} 个子专题。",
    sessionOrganizationDeleteFolderCascadeOption:
      "同时删除内部所有会话（本地文件会被永久删除，不可恢复）",
    sessionOrganizationDeleteFolderUnfileHint:
      "未勾选时，所有相关会话会移到「未分类」，子专题将一并删除。",
    sessionOrganizationDeleteFolderConfirm: "删除",
    sessionOrganizationDeleteFolderCancel: "取消",
    sessionOrganizationDeleteFolderInProgress: "正在删除…",
    sessionOrganizerOpenButton: "会话整理",
    sessionOrganizerOpenButtonAria: "打开会话整理面板",
    sessionOrganizerModalTitle: "整理 — {{workspace}}",
    sessionOrganizerModalSubtitle:
      "按专题查看 / 移动 / 重整会话，批量操作沿用底部工具栏。",
    sessionOrganizerCloseAria: "关闭会话整理面板",
