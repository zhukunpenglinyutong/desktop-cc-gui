const enPart2 = {
  ...
  rewind: {
    ...
    noEligibleMessage: "No rewindable Claude user messages were found.",
    ...
    dialogTitle: "Confirm Claude rewind",
    dialogDescription:
    ...
    impactAssistantMessages: "Claude replies removed",
    impactToolCalls: "Tool calls removed",
    impactFiles: "Files involved",
    impactSummary:
      "After confirmation, the current linear history will roll back from this user message. That includes this user message and all later Claude replies, tool calls, and related changes.",
    impactFollowUp:
