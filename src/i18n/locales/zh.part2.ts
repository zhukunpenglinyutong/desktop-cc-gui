const zhPart2 = {
  ...
  rewind: {
    ...
    impactAssistantMessages: "将移除的 Claude 回复",
    impactToolCalls: "将移除的工具调用",
    impactFiles: "涉及文件",
    impactSummary:
      "确认后，会从这条用户消息开始整体回退。也就是这条用户消息，以及它后面的 Claude 回复、工具调用和相关变更，都会从当前线性历史里移除。",
    impactFollowUp:
